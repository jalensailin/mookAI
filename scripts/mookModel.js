...
class Ability {
  ...
  act(data_) {
    ...
    if (this.data.act === undefined) return null;
...
export class MookModel {
  ...
  // Do not override
  get gridDistance() {
    return game.scenes.active.data.gridDistance;
  }
  get hasMele() {
    return this.settings.useMele && this._hasMele;
  }
  get hasRanged() {
    return this.settings.useRanged && this._hasRanged;
  }
  get hasSight() {
